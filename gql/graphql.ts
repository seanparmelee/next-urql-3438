...
export type QueryAllShipsQueryVariables = Exact<{ [key: string]: never; }>;


export type QueryAllShipsQuery = { __typename?: 'Query', ships?: Array<{ __typename?: 'Ship', id?: string | null, name?: string | null } | null> | null };
...
export const QueryAllShipsDocument = new TypedDocumentString(`
    query queryAllShips {
  ships {
    id
    name
    ...
    `) as unknown as TypedDocumentString<QueryAllShipsQuery, QueryAllShipsQueryVariables>;